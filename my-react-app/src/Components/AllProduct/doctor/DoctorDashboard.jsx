...
const NotificationPanel = ({ open, showAll, onToggleAll, onClose }) => {
  if (!open) return null;

  const notifications = [
    {
      title: "New Appointment",
      desc: "Rajesh Kumar booked for 09:00 AM",
      time: "2 min ago",
      pill: "bg-[#EAFBFF] border-[#00B8DB]",
      dot: "bg-[#00B8DB]",
    },
    {
      title: "Payment Received",
      desc: "Priya Sharma paid ₹200 via UPI",
      time: "32 min ago",
      pill: "bg-[#FFFBEE] border-[#F0B100]",
      dot: "bg-[#F0B100]",
    },
    {
      title: "Report Sent",
      desc: "Amit Patel report sent via WhatsApp",
      time: "1 hr ago",
      pill: "bg-[#F2FFF8] border-[#00C950]",
      dot: "bg-[#00C950]",
    },
  ];

  const visible = showAll ? notifications : notifications.slice(0, 1);
