...
export default function Appointment() {
  ...
  const [notifications, setNotifications] = useState([
    { id: "n1", text: "Rajesh Kumar - New appointment booked", time: "11:57:17 AM", read: false },
    { id: "n2", text: "Priya Sharma - New appointment booked", time: "11:27:17 AM", read: false },
  ]);
  ...
  const [bookingsByDate, setBookingsByDate] = useState(() => ({
    "2026-02-05": {
      "09:00": { patient: "Rajesh Kumar", pid: "P001", phone: "+91 98765 43210", email: "rajesh@example.com", bookedAt: "2/5/2026, 10:12:17 AM", via: "CHATBOT" },
      "10:00": { patient: "Priya Sharma", pid: "P002", phone: "+91 98765 43211", email: "priya@example.com", bookedAt: "2/5/2026, 11:42:17 AM", via: "CHATBOT" },
      "14:00": { patient: "Amit Patel", pid: "P003", phone: "+91 98765 43212", email: "amit@example.com", bookedAt: "2/5/2026, 11:12:17 AM", via: "CHATBOT" },
    },
    "2026-02-10": {
      "09:00": { patient: "Rajesh Kumar", pid: "P001", phone: "+91 98765 43210", email: "rajesh@example.com", bookedAt: "2/10/2026, 09:12:17 AM", via: "CHATBOT" },
      "10:00": { patient: "Priya Sharma", pid: "P002", phone: "+91 98765 43211", email: "priya@example.com", bookedAt: "2/10/2026, 09:42:17 AM", via: "CHATBOT" },
    },
  }));
  ...
  useEffect(() => {
    ...
    setBookingsByDate((prev) => {
      ...
      return changed ? { ...prev, [selectedKey]: nextDay } : prev;
    });
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedKey, daySlots.join("|")]);
        ...
        <div className="mt-6 border-2 border-black bg-white rounded-md">
          ...
          <div className="p-4 space-y-3">
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <div key={n.id} className="border-2 border-black rounded-sm p-3 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-black truncate">{n.text}</div>
                    <div className="text-[11px] text-black/50 mt-1">{n.time}</div>
                  </div>
